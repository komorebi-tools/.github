...
### デザインルール (社内共通、[design-system](https://github.com/komorebi-tools/design-system) で管理)

コモレビの UI を作るプロジェクトには、「はじめかた」のステップ 3 でスキルを追加します。
...
「はじめかた」のステップ 2 で組織共通セットアップを実行すると、以下が自動で入ります。
