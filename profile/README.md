...
- **main に直接 push して OK です。** ブランチや PR は不要です。
- 変更したら Claude Code に「コミットして push して」と伝えてください。
- 壊してしまった場合は Claude Code に「さっきの変更を元に戻して」と伝えれば戻せます。
- .env やパスワードなど機密情報を含むファイルは push しないでください。不安なら Claude Code に「.gitignore に .env が入っているか確認して」と聞いてください。
- 他の人が使っているツールを大きく変えるときは、Slack で一声かけてから作業してください。
