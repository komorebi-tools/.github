...
各メンバーの PC に設定されます。**自分用のルールを追加したい場合は、CLAUDE.md や settings.json を自由に編集して OK です。** 組織共通の内容を消さないようにだけ注意してください。
...
色、フォント、コンポーネントなどのビジュアルプレビュー → https://komorebi-tools.github.io/design-system/
